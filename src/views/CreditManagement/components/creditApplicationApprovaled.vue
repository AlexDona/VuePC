      ...
      <el-row type="flex" style="gap: 24px">
        <el-col v-if="userInfo.custTypeId !==3" :sm="4" :xs="4">
          <el-form-item prop="industryName">
            <el-select v-model="reloadParams.industryName" style="width:100%" clearable placeholder="产业公司名称" filterable>
...
export default {
  name: 'CreditApplicationApprovaled',
  components: {
    // batchImport,
    AccountUpdateDialog,
    Pagination
  ...
  methods: {
    ...
    initEntities() { // 初始化实体数据
      ...
      console.log('getEntitiesList params===', params)
